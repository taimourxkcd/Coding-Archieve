/*
CHECK FOR BALANCED PARANTHESES DIY
INFIX PREFIX POSTFIX
COPIED FROM THE GITHUB OF MYCODESCHOOL
TODO(taimour): Still not implemented successfully. come back to it later 
...
// end of the code i have included 
