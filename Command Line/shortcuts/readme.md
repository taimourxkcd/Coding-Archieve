...
alt + press left click AND  :look below
alt + ctrl + up/down		:creates multiple cursors
...
cntrl + p + > 				:splits the window to the right
cntrl + g  					:jump to anyline you want
shift + d   				:duplicates the line (i have added this myself)
cntrl + shift + L 			:selects a single word all over your document
alt + shift + down key      :duplicate line below
...
ctrl + pageup/down: move to next or previous tab
...
shift + f10				  : right click functionality	 
...
window + h 		:dictate to write or Speech to text
	...
	SUBLIME
ctrl + alt 		:edit multiple lines as once

	WINDOWS TERMINAL 
alt + shift + = :splits your terminal into two in a horizontal way
alt + shift + - :splits your terminal into two in a vertically way
ctrl + shift + w :closes the current open windows pane
